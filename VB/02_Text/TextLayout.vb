...
Namespace TextLayout
	Partial Public Class Form1
		...
		Private Sub button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles button1.Click
			...
			Dim font2 As New PdfTrueTypeFont(New Font("Arial", 18f, FontStyle.Bold))
			...
			'Refenrence content
			Dim font3 As New PdfTrueTypeFont(New Font("Arial", 12f))
			...
			Dim font4 As New PdfTrueTypeFont(New Font("Arial", 12f, FontStyle.Underline))
			...
			Dim font5 As New PdfTrueTypeFont(New Font("Arial", 12f))
